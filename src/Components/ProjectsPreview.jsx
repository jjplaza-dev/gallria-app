...
const PROJECTS = [
    { id: 1, title: "Project One", bg: "bg-green-300", text: "text-green-900" },
    { id: 2, title: "Project Two", bg: "bg-blue-300", text: "text-blue-900" },
    { id: 3, title: "Project Three", bg: "bg-purple-300", text: "text-purple-900" },
    { id: 4, title: "Project Four", bg: "bg-red-300", text: "text-red-900" },
];
...
const ProjectsPreview = () => {
    ...
    return (
        <section ref={parentRef} className='w-full relative bg-zinc-950'>
            
            {PROJECTS.map((project, index) => (
                <div key={project.id} className='sticky-card w-screen h-screen sticky top-0 flex justify-center items-center overflow-hidden bg-zinc-950 border-t border-white/10'>
                    ...
                    <div className={`project-container w-full h-full ${project.bg} overflow-hidden flex flex-col md:flex-row items-center justify-center`}>
                        <div className='image-box w-auto h-full max-sm:w-full max-lg:max-w-[425px] bg-amber-600 aspect-[1/1.5]'>IMAGE</div>
